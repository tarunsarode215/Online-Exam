...
public class search extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
		...
		out.println("table tr th {padding:10px}form input{background: linear-gradient( rgba(255,255,255,0.8),rgba(255,255,255,0.8));padding:15px;color:black;} form{margin-top:30px;}</style></style>");
		out.println("</head>");
    ...
    try
		...
		String q="select * from question where choice='"+s1+"'";
